...
优化数据展示和用户体验，于2021年12月31日正式发布，现已全面开放在线的数据集成（GitLab）和分析展示，注册用户可享受30天免费体验。
...
2021年8月起开发，全面升级数据集成与管理能力、可视化呈现方式，为用户提供更好的操作与体验。提供免费的 Git 日志分析工具 2.0，帮助用户分析代码提交活动，可下钻到人员。

|<nobr>发布时间</nobr> |<nobr>版本号</nobr> |<nobr>类别</nobr> |<nobr>关键词</br> | <nobr>发布特性清单</nobr>|
|:---:| :---: | :---: | :--- | :---
|2022.3.3|V3.2|小版本升级|体验|<ul><li>工作台展示多类项目</li><li>工具箱中展示集成套件</li>
|2022.3.3|V3.1.1|架构升级|性能优化|<ul><li>静态文件请求响应优化</li><li>数据请求响应优化</li>
|2022.1.26|V3.1|小版本升级|体验|<ul><li>自定义过滤器</li><li>集成过滤器与数据源规则</li>
|2021.12.31|V3.0|大版本升级|体验|<ul><li>向导式的数据集成</li><li>多目录的数据管理</li><li>灵活的项目级数据源配置</li><li>Git日志分析工具2.0</li>

### V2.0.3版本

为研发全生命周期提供数据管理与效能洞察能力。

发布日期为：2021年7月11日。

V2.0 三个小版本升级，在集成更多数据源及展现功能之外，对架构进行了整体优化，以提升在线处理和访问性能。

|<nobr>发布时间</nobr> |<nobr>版本号</nobr> |<nobr>类别</nobr> |<nobr>关键词</br> | <nobr>发布特性清单</nobr>|
|:---:| :---: | :---: | :--- | :---
|2021.9.8|V2.0.3|架构升级|性能优化|<ul><li>异步处理服务器架构</li><li>多节点数据复制架构</li><li>程序版本及依赖库整体升级</li>
|2021.8.31|V2.0.3|小版本升级|代码库洞察|<ul><li>GitLab 集成</li><li>单一开发者身份识别</li><li>仓库/分支/代码关键统计指标</li><li>按部门/迭代/开发者归集提交记录</li><li>代码变更检视</li><li>代码行趋势分析</li><li>代码质量问题关联分析</li>
|2021.8.16|V2.0.2|小版本升级|增量数据分析|<ul><li>增量日志获取</li><li>增量数据同步</li><li>数据预处理增量执行规则</li><li>特征增量计算更新实现</li>
|2021.8.7|V2.0.1|小版本升级|免费用户体验|<ul><li>访客分析入口</li><li>团队洞察八组指标</li>
|2021.7.11|V2.0|大版本升级|可扩展的数据平台|<ul><li>新数据架构</li><li>新指标体系及数据仪表板</li><li>时间跟踪数据看板</li><li>交付洞察数据看板</li><li>绩效指标体系及配置模板</li><li>开发者绩效分析</li><li>工时统计分析</li><li>重要指标行业对比</li><li>$X^d$行业指数</li>
